...
/**
 * Implements a single six-sided die that may be rolled and graphically displayed.
 */
...
public class Die extends JPanel
{
	...
	public void paintComponent(Graphics g)
	{
		...
		{
		case 1:
			// subtract 3 pixels due to size of circle
			g.fillOval(21, 21, 6, 6);
			break;
		case 4:
			g.fillOval(13, 29, 6, 6);
			g.fillOval(29, 13, 6, 6); // fall through to case 2 code
		case 2:
		...
		case 6:
			...
			break;
		default: System.err.println("Value is out of bounds: " + value);
			break;
		}
	}
