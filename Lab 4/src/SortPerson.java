...
public class SortPerson
{
	...
	public void sortByName(String name)
	{
		...
		int index = Collections.binarySearch(people, p);
	...
	public void sortByID(int id)
	{
		...
		CompareInt compInt = new CompareInt();
		
		// sort list people by id here
		Collections.sort(people, compInt);
		...
		int index = Collections.binarySearch(people, p, compInt);
